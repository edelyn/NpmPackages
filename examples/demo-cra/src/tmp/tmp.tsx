...
import { MsalConfig } from "@nait-aits/azure-ad-auth";
import { loadMsalConfig } from "@nait-aits/azure-ad-auth/dist/cjs/helpers/loadMsalConfig";
...
export function NaitAzureADAuthProvider(props: {
  ...
  var x = loadMsalConfig(fullConfig);
  console.log(x);
